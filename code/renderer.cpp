...
void CommandBuffer::push_quad(V3 p0, V3 p1, V3 p2, V3 p3, V3 color)
{
    if (!active_draw) {
...
void CommandBuffer::draw_cube(V3 pos, V3 radius, V3 color)
{
    ...
    push_quad(p1, p2, p4, p3, color);
    push_quad(p8, p7, p5, p6, color);
    push_quad(p8, p4, p7, p3, color);
    push_quad(p6, p2, p5, p1, color);
    push_quad(p7, p3, p6, p2, color);
    push_quad(p5, p1, p8, p4, color);
}
